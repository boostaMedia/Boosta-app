/**
 * The provider agreement shown at registration. Bump PROVIDER_CONTRACT_VERSION
 * whenever the text changes materially — existing providers keep whatever
 * version they originally accepted (see providers.contract_version).
 *
 * IMPORTANT: this is standard, generic marketplace-provider boilerplate, not
...
4. Your obligations. You agree to deliver services as described, respond to customers in a timely and professional manner, and keep your listed services and pricing accurate.

5. Review. Boosta reviews new provider applications before activation and may decline an application or suspend an account for inaccurate information, policy violations, or non-payment of fees.

6. Term and termination. This agreement renews annually alongside your access fee unless either party cancels. Boosta may suspend or terminate access for breach of these terms.

7. Governing law. This agreement is governed by the laws of Kuwait.`;

export const PROVIDER_CONTRACT_TEXT_AR = `اتفاقية مزوّدي خدمات بوستا
...
٤. التزاماتك. توافق على تقديم الخدمات كما هو موصوف، والرد على العملاء بشكل مهني وفي الوقت المناسب، والحفاظ على دقة خدماتك وأسعارك المعروضة.

٥. المراجعة. تراجع بوستا طلبات المزوّدين الجدد قبل التفعيل، ويجوز لها رفض طلب أو تعليق حساب بسبب معلومات غير دقيقة أو مخالفة السياسات أو عدم سداد الرسوم.

٦. المدة والإنهاء. تتجدد هذه الاتفاقية سنويًا مع رسوم الوصول ما لم يقم أي طرف بالإلغاء. يجوز لبوستا تعليق أو إنهاء الوصول في حال الإخلال بهذه الشروط.

٧. القانون الحاكم. تخضع هذه الاتفاقية لقوانين دولة الكويت.`;
